...
4. Confirme `/api/health` na URL retornada e então abra no navegador do Codex. Reutilize a aba existente. Não recarregue nem feche abas durante uma edição. Abrir a página comprova abertura, não todas as funções.
